...
spacy_de = spacy.load('es_core_news_sm')
spacy_en = spacy.load('en_core_web_sm')
# spacy_ja = spacy.load('ja_core_news_md')
...
class WMT32k(data.Dataset):
    ...
    urls = ['https://www.statmt.org/wmt13/training-parallel-un.tgz',            
    ...
    def splits(cls, exts, fields, data_dir, root='.data', **kwargs):
        ...
        train_files = ['un/undoc.2000.es-en',
                       'commoncrawl.es-en',
